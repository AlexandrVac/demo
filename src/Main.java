...
public class Main {
    ...
    public static void Arab(String mathematical, String[] mass){
        ...
        //
        if (mas_s.length > 3){
            System.out.println("Математическое выражение должно состоять из 2 переменных и 1 знака");
            System.exit(0);
        }
    ...
    public static void Rom(String[] mas_arab, String[] mas_rome, String mathematical, String[] mass){
    ...
    public static void linee(String[] mas_s){
        //Проверка на то, что бы все выражение было написано в одну строчку
        if (mas_s.length < 2){
            System.out.println("Строка не яляется математической операцией!");
            System.exit(0);
        }
    }
    ...
    public static void cor(String[] mas_s, String[] mass){
        for (int i = 0; i < mass.length; i++) {
            ...
            if (i == 3){
                System.out.println("Введена недоступная операция!");
                System.exit(0);
            }
        }
    }
